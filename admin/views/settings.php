...
class HRB_Settings_Helper {
    ...
    public function get_setting_description(string $key): string {
        $descriptions = [
            ...
            'hrb_booking_start_time' => __('Earliest time a booking may start (24-hour format, e.g., 08:00)', 'hourly-room-booking'),
            'hrb_booking_end_time' => __('Latest time a booking may start (24-hour format, e.g., 23:30). A booking that starts inside the window runs its full length, past this time and past midnight.', 'hourly-room-booking'),
