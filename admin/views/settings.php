...
class HRB_Settings_Helper {
    ...
    public function get_setting_label(string $key): string {
        $labels = [
            ...
            'hrb_booking_start_time' => __('Booking Opening Time', 'hourly-room-booking'),
            'hrb_booking_end_time' => __('Booking Closing Time', 'hourly-room-booking'),
    ...
    public function get_setting_description(string $key): string {
        $descriptions = [
            ...
            'hrb_booking_start_time' => __('The time of day you open for business (24-hour format, e.g., 09:00). Before this, the site will not take a booking.', 'hourly-room-booking'),
            'hrb_booking_end_time' => __('The time of day you close (24-hour format, e.g., 23:00). These two are your opening hours — the hours in which a booking can be placed on the site. They say nothing about which slot is booked: at 23:00, while you are still open, a customer can book a room for 05:00 tomorrow. After closing, no new bookings are taken until you open again. Admins are not restricted.', 'hourly-room-booking'),
