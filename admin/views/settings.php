...
class HRB_Settings_Helper {
    ...
    public function get_setting_description(string $key): string {
        $descriptions = [
            ...
            'hrb_booking_start_time' => __('When bookings open (24-hour format, e.g., 08:00). Nothing can be booked to start before this time.', 'hourly-room-booking'),
            'hrb_booking_end_time' => __('When bookings close (24-hour format, e.g., 23:30). These two times are the window a booking may be *started* in, not how long it may run: a booking can be any length up to 24 hours, and one that starts before closing runs its full length, past this time and past midnight.', 'hourly-room-booking'),
