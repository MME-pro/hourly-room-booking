...
class HRB_Settings_Helper {
    ...
    public function get_setting_label(string $key): string {
        $labels = [
            ...
            'hrb_bank_transfer_enabled' => __('Enable Bank Transfer', 'hourly-room-booking'),
            ...
            'hrb_bank_account_holder' => __('Account Holder', 'hourly-room-booking'),
            'hrb_bank_iban' => __('IBAN', 'hourly-room-booking'),
            'hrb_bank_bic' => __('BIC', 'hourly-room-booking'),
    ...
    public function get_setting_description(string $key): string {
        $descriptions = [
            ...
            'hrb_booking_start_time' => __('The earliest time a booking may start (24-hour format, e.g., 08:00).', 'hourly-room-booking'),
            'hrb_booking_end_time' => __('The latest time a booking may START (24-hour format, e.g., 23:30) — not the time it has to be finished by. A booking that starts at this time runs its full length, past this time and past midnight: with 23:30 here, a 3-hour booking makes 23:30–02:30 the last slot offered.', 'hourly-room-booking'),
            ...
            'hrb_bank_transfer_enabled' => __('Offer Bank Transfer as a payment method when creating or editing a booking in the admin, and show a "Paid by bank transfer" note there. Both are admin-only: neither is ever shown to customers or offered in the public booking form.', 'hourly-room-booking'),
            'hrb_bank_transfer_bank_name' => __('Name of the bank holding the account. Shown on the booking form so whoever reconciles the booking can see which account to look at.', 'hourly-room-booking'),
            ...
            'hrb_bank_account_holder' => __('Bank details for the cancellation-fee invoice. The fee is payable by transfer only.', 'hourly-room-booking'),
