...
<body>
  ...
  array (
    ...
    'html_content' => '<!DOCTYPE html><html lang="de"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Tageszusammenfassung</title><style>@media only screen and (max-width:620px){.px{padding-left:18px!important;padding-right:18px!important;}.stack{display:block!important;width:100%!important;padding:0 0 12px 0!important;}}</style></head><body style="font-family:\'Segoe UI\',-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif;margin:0;padding:0;background:#eef0f4;color:#1f2328;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#eef0f4" style="background:#eef0f4;"><tr><td align="center" style="padding:24px 12px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="width:100%;max-width:640px;background:#ffffff;border-radius:10px;overflow:hidden;"><tr><td bgcolor="#1f2328" style="background:#1f2328;padding:24px 32px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td valign="middle" style="font-family:\'Segoe UI\',-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif;"><div style="color:#9aa3ad;font-size:11px;letter-spacing:.12em;text-transform:uppercase;font-weight:700;">Tageszusammenfassung</div><div style="color:#ffffff;font-size:22px;font-weight:700;padding-top:3px;">{summary_date}</div></td><td valign="middle" align="right">{company_logo_html}</td></tr></table></td></tr><tr><td class="px" style="padding:26px 32px 0 32px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:separate;border-spacing:10px 0;"><tr><td class="stack" width="50%" valign="top" style="font-family:\'Segoe UI\',-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif;padding:0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:separate;"><tr><td bgcolor="#ffffff" style="background:#ffffff;border:1px solid #e3e6ea;border-top:3px solid #2a78d6;border-radius:6px;padding:16px 18px;"><div style="font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#6b7280;font-weight:700;">Neue Buchungen</div><div style="font-size:32px;line-height:1.15;font-weight:700;color:#1f2328;padding-top:6px;">{total_bookings}</div><div style="font-size:13px;color:#6b7280;padding-top:6px;">{confirmed_bookings} bestätigt · {hours_booked} Std.</div></td></tr></table></td><td class="stack" width="50%" valign="top" style="font-family:\'Segoe UI\',-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif;padding:0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:separate;"><tr><td bgcolor="#ffffff" style="background:#ffffff;border:1px solid #e3e6ea;border-top:3px solid #0ca30c;border-radius:6px;padding:16px 18px;"><div style="font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#6b7280;font-weight:700;">Buchungsumsatz</div><div style="font-size:32px;line-height:1.15;font-weight:700;color:#1f2328;padding-top:6px;">{total_revenue}</div><div style="font-size:13px;color:#6b7280;padding-top:6px;">ohne stornierte Buchungen</div></td></tr></table></td></tr></table></td></tr><tr><td class="px" style="padding:30px 32px 0 32px;"><div style="font-size:11px;letter-spacing:.09em;text-transform:uppercase;color:#6b7280;font-weight:700;padding-bottom:2px;">Vor Ort gegen PayPal</div><div style="font-size:13px;color:#6b7280;padding-bottom:14px;">Anteil am Buchungsumsatz des Tages</div>{split_bar}<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;margin-top:10px;">{split_legend}</table></td></tr><tr><td class="px" style="padding:30px 32px 0 32px;"><div style="font-size:11px;letter-spacing:.09em;text-transform:uppercase;color:#6b7280;font-weight:700;padding-bottom:12px;">Nach Zahlungsart</div><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">{payment_method_rows}</table></td></tr><tr><td class="px" style="padding:30px 32px 0 32px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:separate;border-spacing:14px 0;"><tr><td class="stack" width="50%" valign="top"><div style="font-size:11px;letter-spacing:.09em;text-transform:uppercase;color:#6b7280;font-weight:700;padding-bottom:12px;">Buchungsstatus</div><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;"><tr><td style="padding:10px 0;border-bottom:1px solid #eceef1;font-size:14px;"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#0ca30c;margin-right:8px;"></span>Bestätigt</td><td align="right" style="padding:10px 0;border-bottom:1px solid #eceef1;font-size:14px;font-weight:600;">{confirmed_bookings}</td></tr><tr><td style="padding:10px 0;border-bottom:1px solid #eceef1;font-size:14px;"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#fab219;margin-right:8px;"></span>Ausstehend</td><td align="right" style="padding:10px 0;border-bottom:1px solid #eceef1;font-size:14px;font-weight:600;">{pending_bookings}</td></tr><tr><td style="padding:10px 0;font-size:14px;"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#d03b3b;margin-right:8px;"></span>Storniert</td><td align="right" style="padding:10px 0;font-size:14px;font-weight:600;">{cancelled_bookings}</td></tr></table></td><td class="stack" width="50%" valign="top"><div style="font-size:11px;letter-spacing:.09em;text-transform:uppercase;color:#6b7280;font-weight:700;padding-bottom:12px;">Zahlungsstatus</div><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">{payment_status_rows}</table></td></tr></table></td></tr><tr><td class="px" style="padding:30px 32px 0 32px;"><div style="font-size:11px;letter-spacing:.09em;text-transform:uppercase;color:#6b7280;font-weight:700;padding-bottom:12px;">Zahlungen</div><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#f7f8fa" style="background:#f7f8fa;border-radius:6px;border-collapse:separate;"><tr><td style="padding:4px 18px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;"><tr><td style="padding:12px 0;border-bottom:1px solid #eceef1;font-size:14px;color:#1f2328;">Zahlungseingang heute<div style="font-size:12px;color:#6b7280;padding-top:2px;">Anzahl: {payments_count}</div></td><td align="right" style="padding:12px 0;border-bottom:1px solid #eceef1;font-size:18px;font-weight:700;color:#0ca30c;white-space:nowrap;">{payments_received}</td></tr><tr><td style="padding:12px 0;border-bottom:1px solid #eceef1;font-size:14px;color:#1f2328;">Offene Forderungen<div style="font-size:12px;color:#6b7280;padding-top:2px;">aus den heute eingegangenen Buchungen</div></td><td align="right" style="padding:12px 0;border-bottom:1px solid #eceef1;font-size:15px;font-weight:700;color:#1f2328;white-space:nowrap;">{outstanding}</td></tr><tr><td style="padding:12px 0;font-size:14px;color:#1f2328;">Stornogebühren</td><td align="right" style="padding:12px 0;font-size:15px;font-weight:700;color:#1f2328;white-space:nowrap;">{cancellation_fees}</td></tr></table></td></tr></table></td></tr><tr><td class="px" style="padding:30px 32px 0 32px;"><div style="font-size:11px;letter-spacing:.09em;text-transform:uppercase;color:#6b7280;font-weight:700;padding-bottom:2px;">Auslastung nach Raum</div><div style="font-size:13px;color:#6b7280;padding-bottom:14px;">Balken im Verhältnis zum stärksten Raum</div><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">{rooms_rows}</table></td></tr><tr><td class="px" style="padding:28px 32px 30px 32px;"><div style="border-top:1px solid #eceef1;padding-top:18px;font-size:12px;line-height:1.7;color:#6b7280;text-align:center;"><strong style="color:#1f2328;">{company_name}</strong><br>{company_phone} &nbsp;|&nbsp; {company_email}<br><span style="font-size:11px;">Automatisch erstellt – keine Antwort erforderlich.</span></div></td></tr></table></td></tr></table></body></html>',
  ),
  14 => 
  array (
