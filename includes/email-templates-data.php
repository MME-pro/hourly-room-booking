...
<body>
  ...
  array (
    ...
    'message' => 'Übersicht der heute erstellten Buchungen.',
    'html_content' => '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Tageszusammenfassung</title><style>body{font-family:Arial,sans-serif;line-height:1.6;color:#333333;margin:0;padding:0;background-color:#f7f7f7;} .container{max-width:600px;margin:20px auto;background:#ffffff;padding:30px;border:1px solid #e5e5e5;} .header{background-color:#ffffff;padding:20px 0;text-align:center;border-bottom:1px solid #e5e5e5;} .header img{max-width:250px;height:auto;} .content{padding:30px 0 10px 0;} .content p{margin:0 0 15px 0;} .content h3{margin:30px 0 10px 0;font-size:15px;color:#555;} .booking-details{margin:25px 0;border:1px solid #e5e5e5;width:100%;border-collapse:collapse;} .booking-details th,.booking-details td{padding:12px 15px;text-align:left;border-bottom:1px solid #e5e5e5;vertical-align:top;} .booking-details th{background-color:#f7f7f7;width:140px;font-weight:600;color:#555;} .data-table{margin:10px 0 0 0;border:1px solid #e5e5e5;width:100%;border-collapse:collapse;} .data-table th,.data-table td{padding:10px 15px;text-align:left;border-bottom:1px solid #e5e5e5;} .data-table thead th{background-color:#f7f7f7;font-weight:600;color:#555;font-size:13px;} .data-table td.num,.data-table th.num{text-align:right;} .update-box{background:#eaf4fc;padding:20px;margin:0 0 25px 0;border-left:4px solid #2c8bd6;text-align:center;} .update-box h2{margin:0;color:#1f6fb0;font-size:20px;} .amount-row td{background-color:#fffcf5;color:#981b1e;font-weight:bold;font-size:16px;} .empty{color:#777;font-style:italic;} .footer{margin-top:30px;padding-top:20px;border-top:1px solid #e5e5e5;font-size:12px;color:#666666;text-align:center;}</style></head><body><div class="container"><div class="header">{company_logo_html}</div><div class="content"><p>Guten Tag,</p><p>hier ist die Tageszusammenfassung für {summary_date}. Berücksichtigt werden alle Buchungen, die an diesem Tag <strong>erstellt</strong> wurden - unabhängig davon, wann sie stattfinden.</p><div class="update-box"><h2>Tageszusammenfassung {summary_date}</h2></div><table class="booking-details"><tr><th>Neue Buchungen</th><td><strong>{total_bookings}</strong></td></tr><tr><th>davon vor Ort</th><td>{onsite_bookings}</td></tr><tr><th>davon PayPal</th><td>{paypal_bookings}</td></tr><tr><th>Bestätigt</th><td>{confirmed_bookings}</td></tr><tr><th>Ausstehend</th><td>{pending_bookings}</td></tr><tr><th>Storniert</th><td>{cancelled_bookings}</td></tr><tr><th>Gebuchte Stunden</th><td>{hours_booked}</td></tr><tr class="amount-row"><th>Buchungswert</th><td>{total_revenue}</td></tr><tr><th>davon vor Ort</th><td>{onsite_revenue}</td></tr><tr><th>davon PayPal</th><td>{paypal_revenue}</td></tr></table><h3>Nach Zahlungsart</h3><table class="data-table"><thead><tr><th>Zahlungsart</th><th class="num">Buchungen</th><th class="num">Wert</th><th class="num">Heute erhalten</th></tr></thead><tbody>{payment_method_rows}</tbody></table><h3>Zahlungsstatus der neuen Buchungen</h3><table class="data-table">{payment_status_rows}</table><h3>Zahlungen</h3><table class="data-table"><tr><td>Heute erhalten</td><td class="num">{payments_received}</td></tr><tr><td>Noch offen</td><td class="num">{outstanding}</td></tr></table><h3>Nach Raum</h3><table class="data-table"><thead><tr><th>Raum</th><th class="num">Buchungen</th><th class="num">Stunden</th><th class="num">Wert</th></tr></thead><tbody>{rooms_rows}</tbody></table></div><div class="footer"><p><strong>{company_name}</strong><br>{company_phone} | {company_email}</p></div></div></body></html>',
  ),
  14 => 
  array (
